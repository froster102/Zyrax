...
function TrendingCard({ product }) {
    return (
        <>
            <div className="lg:w-[350px] lg:h-[450px] md:w-[250px] md:h-[350px] sm:w-[200px] sm:h-[300px] w-[180px] h-[280px]  border border-stone-300 inline-block ml-2 rounded-xl relative">
