    ...
    return (
        <>
            <div className='w-[211px] rounded-[15px]  mt-8 bg-neutral-200 font-semibold text-lg h-fit shadow-xl'>
                ...
                <Link to='dicount'><p className='border-b border-b-[#CFCBCB] px-4 py-2'>Discount</p></Link>
                <Link to='discount'><p className='border-b border-b-[#CFCBCB] px-4 py-2 text-nowrap'>Category Discount</p></Link>
